...
import it.italiandudes.iiot_smartroom.javafx.controllers.tabs.ControllerSceneSimulationTabElectricalPanel;
...
public final class SceneSimulationTabElectricalPanel {
    ...
    private static SceneController genScene(@NotNull final DataCollectorAndManager dcm) {
        try {
            FXMLLoader loader = new FXMLLoader(Defs.Resources.get(JFXDefs.Resources.FXML.SimulationTabs.TAB_ELECTRICAL_PANEL));
            Parent root = loader.load();
            ControllerSceneSimulationTabElectricalPanel controller = loader.getController();
