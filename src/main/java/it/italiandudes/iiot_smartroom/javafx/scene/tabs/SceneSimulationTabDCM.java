...
import it.italiandudes.iiot_smartroom.javafx.controllers.tabs.ControllerSceneSimulationTabDCM;
...
public final class SceneSimulationTabDCM {
    ...
    private static SceneController genScene(@NotNull final DataCollectorAndManager dcm) {
        try {
            FXMLLoader loader = new FXMLLoader(Defs.Resources.get(JFXDefs.Resources.FXML.SimulationTabs.TAB_DCM));
            Parent root = loader.load();
            ControllerSceneSimulationTabDCM controller = loader.getController();
