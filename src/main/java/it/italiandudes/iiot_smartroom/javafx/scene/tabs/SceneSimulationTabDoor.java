...
import it.italiandudes.iiot_smartroom.javafx.controllers.tabs.ControllerSceneSimulationTabDoor;
...
public final class SceneSimulationTabDoor {
    ...
    private static SceneController genScene(@NotNull final DataCollectorAndManager dcm) {
        try {
            FXMLLoader loader = new FXMLLoader(Defs.Resources.get(JFXDefs.Resources.FXML.SimulationTabs.TAB_DOOR));
            Parent root = loader.load();
            ControllerSceneSimulationTabDoor controller = loader.getController();
