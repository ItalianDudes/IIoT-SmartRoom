...
import it.italiandudes.iiot_smartroom.javafx.controllers.tabs.ControllerSceneSimulationTabEnvironmentalMonitor;
...
public final class SceneSimulationTabEnvironmentalMonitor {
    ...
    private static SceneController genScene(@NotNull final DataCollectorAndManager dcm) {
        try {
            FXMLLoader loader = new FXMLLoader(Defs.Resources.get(JFXDefs.Resources.FXML.SimulationTabs.TAB_ENVIRONMENTAL_MONITOR));
            Parent root = loader.load();
            ControllerSceneSimulationTabEnvironmentalMonitor controller = loader.getController();
