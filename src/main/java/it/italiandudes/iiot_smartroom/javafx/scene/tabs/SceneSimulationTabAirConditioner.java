...
import it.italiandudes.iiot_smartroom.javafx.controllers.tabs.ControllerSceneSimulationTabAirConditioner;
...
public final class SceneSimulationTabAirConditioner {
    ...
    private static SceneController genScene(@NotNull final DataCollectorAndManager dcm) {
        try {
            FXMLLoader loader = new FXMLLoader(Defs.Resources.get(JFXDefs.Resources.FXML.SimulationTabs.TAB_CONDITIONER));
            Parent root = loader.load();
            ControllerSceneSimulationTabAirConditioner controller = loader.getController();
